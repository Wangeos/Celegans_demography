...
bedtools multiinter -i ${BED_DIR1}/ECA1261/${VAR1}_mask.bed.gz \
  ${BED_DIR1}/ECA1286/${VAR1}_mask.bed.gz \
  ${BED_DIR1}/ECA1289/${VAR1}_mask.bed.gz \
  ${BED_DIR1}/ECA1891/${VAR1}_mask.bed.gz \
  ${BED_DIR1}/ECA746/${VAR1}_mask.bed.gz \
