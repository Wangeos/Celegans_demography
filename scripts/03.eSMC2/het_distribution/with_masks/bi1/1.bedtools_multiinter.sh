...
bedtools multiinter -i ${BED_DIR1}/ECA1276/${VAR1}_mask.bed.gz \
  ${BED_DIR1}/ECA1278/${VAR1}_mask.bed.gz \
  ${BED_DIR1}/ECA1284/${VAR1}_mask.bed.gz \
  ${BED_DIR1}/ECA2475/${VAR1}_mask.bed.gz \
