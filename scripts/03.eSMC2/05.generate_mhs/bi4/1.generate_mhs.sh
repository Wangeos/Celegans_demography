...
./generate_multihetsep.py \
        ...
        --mask=${BED_DIR1}/ECA1289/${VAR1}_mask.bed.gz \
        --mask=${BED_DIR1}/ECA1891/${VAR1}_mask.bed.gz \
        --mask=${BED_DIR1}/ECA746/${VAR1}_mask.bed.gz \
       	--mask=${BED_DIR2}/${VAR1}.mask.bed.gz \
        ${VCF_DIR}/ECA1261/${VAR1}.hom.vcf.gz \
        ${VCF_DIR}/ECA1286/${VAR1}.hom.vcf.gz \
        ${VCF_DIR}/ECA1289/${VAR1}.hom.vcf.gz \
        ${VCF_DIR}/ECA1891/${VAR1}.hom.vcf.gz \
        ${VCF_DIR}/ECA746/${VAR1}.hom.vcf.gz \
        	> output/hawaii_g.bi4.${VAR1}.mhs
