...
./generate_multihetsep.py \
        --mask=${BED_DIR1}/ECA1276/${VAR1}_mask.bed.gz \
        --mask=${BED_DIR1}/ECA1278/${VAR1}_mask.bed.gz \
        --mask=${BED_DIR1}/ECA1284/${VAR1}_mask.bed.gz \
        --mask=${BED_DIR1}/ECA2475/${VAR1}_mask.bed.gz \
       	--mask=${BED_DIR2}/${VAR1}.mask.bed.gz \
        ${VCF_DIR}/ECA1276/${VAR1}.hom.vcf.gz \
        ${VCF_DIR}/ECA1278/${VAR1}.hom.vcf.gz \
        ${VCF_DIR}/ECA1284/${VAR1}.hom.vcf.gz \
        ${VCF_DIR}/ECA2475/${VAR1}.hom.vcf.gz \
        	> output/hawaii_g.bi1.${VAR1}.mhs
