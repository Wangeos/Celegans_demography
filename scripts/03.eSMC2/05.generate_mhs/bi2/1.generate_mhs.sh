...
./generate_multihetsep.py \
        --mask=${BED_DIR1}/ECA191/${VAR1}_mask.bed.gz \
        --mask=${BED_DIR1}/ECA722/${VAR1}_mask.bed.gz \
        --mask=${BED_DIR1}/ECA723/${VAR1}_mask.bed.gz \
        --mask=${BED_DIR1}/ECA730/${VAR1}_mask.bed.gz \
       	--mask=${BED_DIR2}/${VAR1}.mask.bed.gz \
        ${VCF_DIR}/ECA191/${VAR1}.hom.vcf.gz \
        ${VCF_DIR}/ECA722/${VAR1}.hom.vcf.gz \
        ${VCF_DIR}/ECA723/${VAR1}.hom.vcf.gz \
        ${VCF_DIR}/ECA730/${VAR1}.hom.vcf.gz \
        	> output/hawaii_g.bi2.${VAR1}.mhs
